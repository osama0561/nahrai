...
const faqs = [
  ...
  {
    q: "هل تعملون خارج قطاع اللوجستيات؟",
    a: "نعم، نخدم أي شركة B2B في المملكة العربية السعودية. لكن تخصصنا الأول هو قطاع اللوجستيات حيث نملك أعمق خبرة وأقوى نتائج مثبتة.",
  },
  {
