...
نبني كل وكيل بناءً على احتياجاتك المحددة: سواء كان يتابع العملاء المحتملين، يجيب على استفسارات المشترين، يحلل المنافسين أسبوعياً، أو يدير حملاتك التسويقية — كل ذلك بشكل تلقائي كامل.`,
    ...
    logistics: "في اللوجستيات: وكيل يرد على طلبات الشحن الواردة، يسعّر تلقائياً بناءً على المسار والوزن، ويرسل التأكيدات — بدون تدخل بشري.",
  },
  {
    icon: Workflow,
    title: "أنظمة الأتمتة",
    subtitle: "تلغي العمل اليدوي المتكرر",
    img: "https://images.unsplash.com/photo-1518186285589-2f7649de83e0?w=800&auto=format&fit=crop&q=80",
    desc: `معظم الشركات تضيع ٣٠٪ من طاقتها البشرية في مهام يمكن أتمتتها: إدخال بيانات، إرسال متابعات، توليد تقارير، إصدار فواتير.

نبني سير عمل آلية تربط أنظمتك المختلفة معاً — CRM، ERP، واتساب، البريد الإلكتروني، وأي أداة أخرى — لتعمل كمنظومة واحدة متكاملة.`,
    examples: [
      { title: "أتمتة عروض الأسعار", desc: "من طلب العميل إلى عرض سعر احترافي في الإيميل — خلال دقيقتين." },
      { title: "نظام تأهيل العملاء", desc: "يصنّف العملاء الجدد، يرسل التحيات، ويضيفهم للنظام المناسب تلقائياً." },
      { title: "أتمتة الفواتير والتحصيل", desc: "إصدار فواتير آلي، متابعة المدفوعات المتأخرة، وإرسال تذكيرات." },
      { title: "التقارير الأسبوعية", desc: "داشبورد أداء يصل إلى بريدك كل إثنين صباحاً بدون أي تدخل." },
    ],
    logistics: "في اللوجستيات: أتمتة إصدار وثائق الشحن، تحديثات التتبع للعملاء، وإشعارات التأخير — تلقائياً وفورياً.",
  },
  {
    icon: AppWindow,
...
من بوابات العملاء إلى لوحات تتبع السائقين، كل تطبيق يُصمَّم مع فريقك ويُنشر ضمن البنية التحتية لشركتك.`,
    ...
    logistics: "في اللوجستيات: تطبيق تتبع أسطول يعرض موقع كل مركبة، حالة التسليمات، وتقارير السائقين — في الوقت الفعلي.",
  },
  {
    icon: TrendingUp,
    title: "بنية النمو",
...
كل عنصر مُصمَّم لتحويل الزوار إلى عملاء محتملين وتأهيلهم قبل أن يصلوا إليك.`,
    ...
    logistics: "في اللوجستيات: موقع يستهدف مدراء سلسلة التوريد بمحتوى محدد، مع نظام بريد بارد يصل لهم مباشرة على LinkedIn وإيميلهم.",
  },
  {
    icon: Lightbulb,
...
جلساتنا الشهرية ليست فقط لمراجعة الأرقام — إنها لاتخاذ قرارات استراتيجية مبنية على بيانات حقيقية من عملياتك.`,
    ...
    logistics: "في اللوجستيات: استراتيجية واضحة لأتمتة المستودع، تحسين مسارات التوزيع، وتقليل تكاليف التشغيل بنسب قابلة للقياس.",
  },
];
        ...
        <div className={`grid grid-cols-1 lg:grid-cols-2 gap-12 items-center ${!isEven ? "lg:grid-flow-col-dense" : ""}`}>
          ...
          <div className={!isEven ? "lg:col-start-2" : ""}>
            ...
            <div className="p-5 rounded-2xl flex gap-4" style={{ background: "rgba(0,80,160,0.2)", border: "1px solid rgba(0,163,255,0.25)" }}>
              ...
              <div>
                <p className="text-xs font-bold mb-1" style={{ color: "#00A3FF", fontFamily: "IBM Plex Mono" }}>مثال من اللوجستيات</p>
    ...
    <>
      ...
      <section ref={heroRef} className="pt-40 pb-24 px-6 text-center relative overflow-hidden" style={{ background: "linear-gradient(180deg, #020B19 0%, #001830 100%)" }}>
        ...
        <p className="hero-s text-base md:text-lg max-w-2xl mx-auto" style={{ color: "rgba(240,244,255,0.6)", opacity: 0 }}>
          خمسة محاور تكمل بعضها — من الأتمتة إلى الاستراتيجية. كل محور يُبنى وفق احتياجاتك الفعلية.
        </p>
      </section>
      ...
      <section className="py-24 px-6 text-center" style={{ background: "#0A1628" }}>
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-base mb-10" style={{ color: "rgba(240,244,255,0.55)" }}>استشارة مجانية — نشرح لك بالضبط أين تبدأ.</p>
